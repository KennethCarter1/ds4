...
namespace Laboratorio14
{
    ...
    {
        string connectionString = @"Server=localhost;Database=Productos;TrustServerCertificate=True;Integrated Security=True;";
        bool nuevo;
        public frmProductos()
        {
            InitializeComponent();
        ...
        private void tsbBuscar_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand(sql, con);
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.AddWithValue("@id", int.Parse(tstId.Text));
